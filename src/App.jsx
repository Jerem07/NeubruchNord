...
const SUPABASE_URL = "https://yocoqkcblrxwrqesqhng.supabase.co";
const SUPABASE_KEY = "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6InlvY29xa2NibHJ4d3JxZXNxaG5nIiwicm9sZSI6ImFub24iLCJpYXQiOjE3ODIzMTkyNzUsImV4cCI6MjA5Nzg5NTI3NX0.BTRPj_DDYO1wodhitTTtw8jkB16OHwo1-5A0foZeij8";
...
export default function App() {
  ...
  async function joinSession() {
    ...
    try {
      ...
      await api.upsertMember({ session_id: code, name: nameInput.trim(), score: 0 });
      let m = [], i = [];
      try { m = await api.getMembers(code); } catch(e2) {}
      try { i = await api.getItems(code); } catch(e2) {}
      setSessionData(s[0]); setMembersData(m || []); setItemsData(i || []);
      setCurrentSession(code); setCurrentUser(nameInput.trim()); setScreen("session"); setError("");
    } catch (e) {
